...
resource "aws_api_gateway_resource" "request_upload_resource" {
...
resource "aws_api_gateway_method" "uploader_method" {
  rest_api_id   = var.rest_api_id
  resource_id   = aws_api_gateway_resource.request_upload_resource.id
  http_method   = "GET"
...
resource "aws_api_gateway_integration" "upload_request_lambda_integration" {
  rest_api_id             = var.rest_api_id
  resource_id             = aws_api_gateway_resource.request_upload_resource.id
  http_method             = aws_api_gateway_method.uploader_method.http_method
